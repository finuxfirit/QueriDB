...
{
	/* 
	FUNCTION CREATED BY: Gavin Sao (original)
		             Nash Hymet (same person but older)
	...
	UPDATES: 
                    2021-01-02 : Moved code from one Github account to another; nothing new changed...yet.
